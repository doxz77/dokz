...
echo "\n";
echo "\e[96m            (WELCOME TO MOBILE LEGEND $input)               \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
echo color("yellow","[•] Time : ".date('[d-m-Y] [H:i:s]')." \n");
echo color("purple","[•] HARUS SETUJU KALO GW GANTENG ..... \n");
echo color("green","[•] NGGA SETUJU PASTI GAGAL \n");
echo color("red","[•] powered by : Kodokz Ganteng \n");
echo color("nevy","[•] SCRIPT GOFOOD  \n");
echo color("red","# # # # # # # # # # # # # # # # # # # # # # # \n");
// function change(){
        $nama = nama();
        ...
        $TOKEN  = "1";
         ...
         echo color("red","-] NOMOR GAGAL");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("purple","!] MANDI DULU \n");
         }
//  }
